...
async def about_callback(client: Client, callback_query: CallbackQuery):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="🎁ɪɴsᴛᴀ🎁", url=f"instagram.com/MRDADGOKU"),
            InlineKeyboardButton(text="💲ʏᴏᴜᴛᴜʙᴇ💲", url=f"youtube.com/@GOKUxEDITION"),
        ],
        [
...
async def back_button_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                text="🌱ɢɪᴛʜᴜʙ🌱",
                url="https://github.com/MRDADGOKU",
            ),
        ],
        [
