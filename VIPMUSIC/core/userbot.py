...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("stuckwintu")
                await self.one.join_chat("GOKUxEDITION")
                await self.one.join_chat("OgNobitaa")
                await self.one.join_chat("AU_XD")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("stuckwintu")
                await self.two.join_chat("GOKUxEDITION")
                await self.two.join_chat("OgNobitaa")
                await self.two.join_chat("AU_XD")
            except:
                pass
            assistants.append(2)
